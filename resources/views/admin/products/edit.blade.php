  ...
  <div class="col-md ">
    ...
    <div class="card card-primary">
      <div class="card-header">
        <h3 class="card-title">Cập nhật sản phẩm mới</h3>
      </div>
      <!-- /.card-header -->
      <!-- form start -->
          ...
          <div class="row">
            ...
            <div class="col-md-6">
              <div class="form-group">
                ...
                <input type="text" class="form-control" id="product_name" placeholder="Tên sản phẩm" name="name" value="{{$product->name}}">
              </div>
            </div>
            <div class="col-md-6">
              <div class="form-group">
                <label for="product_category">Danh mục sản phẩm</label>
                    <select id="product_category" class="form-control multiple-category" name="category_id[]" multiple>
                      @foreach($category as $productCategory)
                          <option value="{{ $productCategory->id }}" {{ $product->categories->contains($productCategory->id) ? 'selected' : '' }}>
           ...
           <div class="col-md-6">
            ...
            <div class="col-md-6">
              <div class="form-group">
                ...
                <input type="number" class="form-control" id="sale_price" placeholder="Giá khuyến mãi" name="sale_price" value={{$product->sale_price}}>
              </div>
            </div>
           <div class="col-md-12">
              <div class="form-group">
